            ...
            for (int numOfGeneration = 1; numOfGeneration < 3; numOfGeneration++) {
                ...
                for (int i = 8; i < 12; i++) {
                    for (int j = 0; j < 3; j++) {
                        ...
                        population[i][j] = (newPopulation[sortRank[i - 8]][j] + newPopulation[sortRank[i - 4]][j]) / 2;
                    }
                }
                for (int i = 12; i < 16; i++) {
                    for (int j = 0; j < 3; j++) {
                ...
                if (rand.nextDouble() < 0.2) {
                    population[12][1] = rand.nextDouble()*0.1+population[12][1];
                }
                System.out.println("\n\n\n");
